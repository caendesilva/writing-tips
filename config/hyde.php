...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Writing Tips'),
    ...
    */
    ...
    'url' => env('SITE_URL', 'https://writing-tips.desilva.se'),
    ...
    */
    ...
    'footer' => 'Site proudly built with [HydePHP](https://github.com/hydephp/hyde) - Site source code on [GitHub](https://github.com/caendesilva/writing-tips) <img width="20px" style="display: inline;margin: 0;margin-left: 2px;top: -2px;position: relative;" src="https://github.githubassets.com/images/icons/emoji/octocat.png" alt=":octocat:">',
